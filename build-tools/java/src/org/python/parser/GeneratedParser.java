...
class GeneratedParser<T> extends Parser<T> {
    ...
    private T[] _import_from_targets() {
        ...
        {
            if (
                this.invalid_import_from_targets() != null
            ) {
                return ast.None();
            }
            this.reset(mark);
    ...
    private T _func_type_comment() {
        ...
        {
            if (
                this.invalid_double_type_comments() != null
            ) {
                return ast.None();
            }
            this.reset(mark);
    ...
    private T _star_expressions() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                ...
                &&
                (b = null_if_empty(this._loop1_70())) != null
                &&
                ((literal = this.expectStr(',')) != null || true)
            ) {
    ...
    private T _named_expression() {
        ...
        {
            if (
                this.invalid_named_expression() != null
            ) {
                return ast.None();
            }
            this.reset(mark);
    ...
    private T _expressions() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                (a = this.expression()) != null
                &&
                (b = null_if_empty(this._loop1_73())) != null
                &&
                ((literal = this.expectStr(',')) != null || true)
            ) {
                return ast.Tuple ( ast.seq_insert_in_front ( a , b ) , ast.Load() , line_no , col_offset );
    ...
    private T _lambda_params() {
        ...
        {
            if (
                this.invalid_lambda_parameters() != null
            ) {
                return ast.None();
            }
            this.reset(mark);
    ...
    private T _lambda_parameters() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                ...
                &&
                (b = this._loop0_74()) != null
                &&
                (c = this._loop0_75()) != null
                &&
        ...
        }
        {
            ...
            T c;
            if (
                (a = null_if_empty(this._loop1_77())) != null
                &&
    ...
    private T[] _lambda_slash_no_default() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            Token literal_1;
            if (
                (a = null_if_empty(this._loop1_80())) != null
                &&
                (literal = this.expectStr('/')) != null
                &&
                (literal_1 = this.expectStr(',')) != null
    ...
    private T _lambda_slash_with_default() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            Token literal_1;
            if (
                (a = this._loop0_82()) != null
                &&
                (b = null_if_empty(this._loop1_83())) != null
                &&
                (literal = this.expectStr('/')) != null
                &&
                (literal_1 = this.expectStr(',')) != null
    ...
    private T _lambda_star_etc() {
        ...
        {
            if (
                this.invalid_lambda_star_etc() != null
            ) {
                return ast.None();
            }
            this.reset(mark);
    ...
    private T _disjunction() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                ...
                &&
                (b = null_if_empty(this._loop1_88())) != null
            ) {
    ...
    private T _atom() {
        ...
        {
            if (
                this.expectKeyword("__peg_parser__") != null
            ) {
    ...
    private T _strings() {
        ...
        int col_offset = this.col_offset();
        {
            T[] a;
            if (
                (a = null_if_empty(this._loop1_97())) != null
            ) {
    ...
    private T _listcomp() {
        ...
        {
            if (
                this.invalid_comprehension() != null
            ) {
                return ast.None();
            }
            this.reset(mark);
    ...
    private T _set() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                (literal = this.expectStr('{')) != null
                &&
                (a = this.star_named_expressions()) != null
                &&
                (literal_1 = this.expectStr('}')) != null
            ) {
    ...
    private T _dictcomp() {
        ...
        {
            if (
                this.invalid_dict_comprehension() != null
            ) {
                return ast.None();
            }
            this.reset(mark);
    ...
    private T[] _for_if_clauses() {
        ...
        int col_offset = this.col_offset();
        {
            T[] _loop1_102;
            if (
                (_loop1_102 = null_if_empty(this._loop1_102())) != null
            ) {
                return _loop1_102;
            }
            this.reset(mark);
    ...
    private T _args() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            T[] b;
            if (
                (a = this._gather_105()) != null
                &&
                ((b = this._tmp_107()) != null || true)
            ) {
    ...
    private T[] _kwargs() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            T[] b;
            if (
                (a = this._gather_108()) != null
                &&
                (literal = this.expectStr(',')) != null
                &&
                (b = this._gather_110()) != null
            ) {
        ...
        }
        {
            T[] _gather_112;
            if (
                (_gather_112 = this._gather_112()) != null
            ) {
                return _gather_112;
            }
            this.reset(mark);
    ...
    private final Map<Integer, Memo<T[]>> star_targets_list_seq_cache = new HashMap<>();
    
    protected T[] star_targets_list_seq() {
        int p = this.mark();
        Memo<T[]> info = star_targets_list_seq_cache.get(p);
        if (info != null) {
            log("star_targets_list_seq() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("star_targets_list_seq() ...");
        this._level += 1;
        T[] result = _star_targets_list_seq();
        this._level -= 1;
        log("star_targets_list_seq() [fresh]-> ", result);
        if (result != null) {
            star_targets_list_seq_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] _star_targets_list_seq() {
    ...
    private final Map<Integer, Memo<T[]>> star_targets_tuple_seq_cache = new HashMap<>();
    
    protected T[] star_targets_tuple_seq() {
        int p = this.mark();
        Memo<T[]> info = star_targets_tuple_seq_cache.get(p);
        if (info != null) {
            log("star_targets_tuple_seq() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("star_targets_tuple_seq() ...");
        this._level += 1;
        T[] result = _star_targets_tuple_seq();
        this._level -= 1;
        log("star_targets_tuple_seq() [fresh]-> ", result);
        if (result != null) {
            star_targets_tuple_seq_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] _star_targets_tuple_seq() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                (a = this.star_target()) != null
                &&
                (b = null_if_empty(this._loop1_119())) != null
                &&
                ((literal = this.expectStr(',')) != null || true)
            ) {
                return ast.seq_insert_in_front ( a , b );
            }
            this.reset(mark);
        }
        {
    ...
    private T _star_target() {
        ...
        {
            T target_with_star_atom;
            if (
                (target_with_star_atom = this.target_with_star_atom()) != null
            ) {
    ...
    private final Map<Integer, Memo<T>> target_with_star_atom_cache = new HashMap<>();
    
    protected T target_with_star_atom() {
        int p = this.mark();
        Memo<T> info = target_with_star_atom_cache.get(p);
        if (info != null) {
            log("target_with_star_atom() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("target_with_star_atom() ...");
        this._level += 1;
        T result = _target_with_star_atom();
        this._level -= 1;
        log("target_with_star_atom() [fresh]-> ", result);
        if (result != null) {
            target_with_star_atom_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _target_with_star_atom() {
    ...
    private T _star_atom() {
        ...
        }
        {
            ...
            if (
                (literal = this.expectStr('(')) != null
                &&
                (a = this.target_with_star_atom()) != null
                &&
                (literal_1 = this.expectStr(')')) != null
            ) {
                return ast.set_expr_context ( a , ast.Store() );
        ...
        }
        {
            ...
            if (
                (literal = this.expectStr('(')) != null
                &&
                ((a = this.star_targets_tuple_seq()) != null || true)
                &&
                (literal_1 = this.expectStr(')')) != null
            ) {
        ...
        }
        {
            ...
            if (
                (literal = this.expectStr('[')) != null
                &&
                ((a = this.star_targets_list_seq()) != null || true)
                &&
                (literal_1 = this.expectStr(']')) != null
            ) {
    ...
    private final Map<Integer, Memo<T>> invalid_arguments_cache = new HashMap<>();
    
    protected T invalid_arguments() {
        int p = this.mark();
        Memo<T> info = invalid_arguments_cache.get(p);
        if (info != null) {
            log("invalid_arguments() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_arguments() ...");
        this._level += 1;
        T result = _invalid_arguments();
        this._level -= 1;
        log("invalid_arguments() [fresh]-> ", result);
        if (result != null) {
            invalid_arguments_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_arguments() {
        ...
        }
        {
            ...
            if (
                (a = this.expression()) != null
                &&
                (for_if_clauses = this.for_if_clauses()) != null
                &&
                (literal = this.expectStr(',')) != null
                &&
                ((_tmp_123 = this._tmp_123()) != null || true)
            ) {
        ...
        }
        {
            ...
            if (
                ...
                return ast.nonparen_genexp_in_call ( a );
            }
            this.reset(mark);
        }
        {
        ...
        }
        {
            ...
            if (
                ...
                return ast.arguments_parsing_error ( a );
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> invalid_kwarg_cache = new HashMap<>();
    
    protected T invalid_kwarg() {
        int p = this.mark();
        Memo<T> info = invalid_kwarg_cache.get(p);
        if (info != null) {
            log("invalid_kwarg() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_kwarg() ...");
        this._level += 1;
        T result = _invalid_kwarg();
        this._level -= 1;
        log("invalid_kwarg() [fresh]-> ", result);
        if (result != null) {
            invalid_kwarg_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_kwarg() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            Token b;
            if (
                this.negative_lookahead(this::_tmp_124)
                &&
                (a = this.expression()) != null
                &&
                (b = this.expectStr('=')) != null
            ) {
    ...
    private final Map<Integer, Memo<T>> invalid_named_expression_cache = new HashMap<>();
    
    protected T invalid_named_expression() {
        int p = this.mark();
        Memo<T> info = invalid_named_expression_cache.get(p);
        if (info != null) {
            log("invalid_named_expression() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_named_expression() ...");
        this._level += 1;
        T result = _invalid_named_expression();
        this._level -= 1;
        log("invalid_named_expression() [fresh]-> ", result);
        if (result != null) {
            invalid_named_expression_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_named_expression() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                ...
                return RAISE_SYNTAX_ERROR_KNOWN_LOCATION ( a , "cannot use assignment expressions with %s" , ast.get_expr_name ( a ) );
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> invalid_assignment_cache = new HashMap<>();
    
    protected T invalid_assignment() {
        int p = this.mark();
        Memo<T> info = invalid_assignment_cache.get(p);
        if (info != null) {
            log("invalid_assignment() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_assignment() ...");
        this._level += 1;
        T result = _invalid_assignment();
        this._level -= 1;
        log("invalid_assignment() [fresh]-> ", result);
        if (result != null) {
            invalid_assignment_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_assignment() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            T expression;
            if (
                (a = this.invalid_ann_assign_target()) != null
                &&
                (literal = this.expectStr(':')) != null
                &&
                (expression = this.expression()) != null
            ) {
                return RAISE_SYNTAX_ERROR_KNOWN_LOCATION ( a , "only single target (not %s) can be annotated" , ast.get_expr_name ( a ) );
            }
            this.reset(mark);
        }
        {
            ...
            T expression;
            if (
                (a = this.star_named_expression()) != null
                &&
                (literal = this.expectStr(',')) != null
                &&
                (_loop0_125 = this._loop0_125()) != null
                &&
                (literal_1 = this.expectStr(':')) != null
                &&
                (expression = this.expression()) != null
        ...
        }
        {
            ...
            Token literal;
            if (
                (_loop0_126 = this._loop0_126()) != null
                &&
                (a = this.star_expressions()) != null
                &&
                (literal = this.expectStr('=')) != null
            ) {
                return RAISE_SYNTAX_ERROR_INVALID_TARGET ( TargetsType.STAR_TARGETS , a );
            }
            this.reset(mark);
        }
        {
            ...
            Token literal;
            if (
                (_loop0_127 = this._loop0_127()) != null
                &&
                (a = this.yield_expr()) != null
                &&
                (literal = this.expectStr('=')) != null
            ) {
        ...
        }
        {
            ...
            if (
                (a = this.star_expressions()) != null
                &&
                (augassign = this.augassign()) != null
                &&
                (_tmp_128 = this._tmp_128()) != null
            ) {
                return RAISE_SYNTAX_ERROR_KNOWN_LOCATION ( a , "'%s' is an illegal expression for augmented assignment" , ast.get_expr_name ( a ) );
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> invalid_ann_assign_target_cache = new HashMap<>();
    
    protected T invalid_ann_assign_target() {
        int p = this.mark();
        Memo<T> info = invalid_ann_assign_target_cache.get(p);
        if (info != null) {
            log("invalid_ann_assign_target() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_ann_assign_target() ...");
        this._level += 1;
        T result = _invalid_ann_assign_target();
        this._level -= 1;
        log("invalid_ann_assign_target() [fresh]-> ", result);
        if (result != null) {
            invalid_ann_assign_target_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_ann_assign_target() {
    ...
    private final Map<Integer, Memo<T>> invalid_del_stmt_cache = new HashMap<>();
    
    protected T invalid_del_stmt() {
        int p = this.mark();
        Memo<T> info = invalid_del_stmt_cache.get(p);
        if (info != null) {
            log("invalid_del_stmt() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_del_stmt() ...");
        this._level += 1;
        T result = _invalid_del_stmt();
        this._level -= 1;
        log("invalid_del_stmt() [fresh]-> ", result);
        if (result != null) {
            invalid_del_stmt_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_del_stmt() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                ...
                return RAISE_SYNTAX_ERROR_INVALID_TARGET ( TargetsType.DEL_TARGETS , a );
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> invalid_block_cache = new HashMap<>();
    
    protected T invalid_block() {
        int p = this.mark();
        Memo<T> info = invalid_block_cache.get(p);
        if (info != null) {
            log("invalid_block() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_block() ...");
        this._level += 1;
        T result = _invalid_block();
        this._level -= 1;
        log("invalid_block() [fresh]-> ", result);
        if (result != null) {
            invalid_block_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_block() {
        ...
        int col_offset = this.col_offset();
        {
            if (
                this.expect(TokenType.NEWLINE) != null
                &&
                this.negative_lookahead(this::expect, TokenType.INDENT)
            ) {
    ...
    private final Map<Integer, Memo<T>> invalid_primary_cache = new HashMap<>();
    
    protected T invalid_primary() {
        return _invalid_primary();
    }
    
    private T _invalid_primary() {
    ...
    private final Map<Integer, Memo<T>> invalid_comprehension_cache = new HashMap<>();
    
    protected T invalid_comprehension() {
        int p = this.mark();
        Memo<T> info = invalid_comprehension_cache.get(p);
        if (info != null) {
            log("invalid_comprehension() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_comprehension() ...");
        this._level += 1;
        T result = _invalid_comprehension();
        this._level -= 1;
        log("invalid_comprehension() [fresh]-> ", result);
        if (result != null) {
            invalid_comprehension_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_comprehension() {
    ...
    private final Map<Integer, Memo<T>> invalid_dict_comprehension_cache = new HashMap<>();
    
    protected T invalid_dict_comprehension() {
        int p = this.mark();
        Memo<T> info = invalid_dict_comprehension_cache.get(p);
        if (info != null) {
            log("invalid_dict_comprehension() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_dict_comprehension() ...");
        this._level += 1;
        T result = _invalid_dict_comprehension();
        this._level -= 1;
        log("invalid_dict_comprehension() [fresh]-> ", result);
        if (result != null) {
            invalid_dict_comprehension_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_dict_comprehension() {
    ...
    private final Map<Integer, Memo<T>> invalid_parameters_cache = new HashMap<>();
    
    protected T invalid_parameters() {
        int p = this.mark();
        Memo<T> info = invalid_parameters_cache.get(p);
        if (info != null) {
            log("invalid_parameters() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_parameters() ...");
        this._level += 1;
        T result = _invalid_parameters();
        this._level -= 1;
        log("invalid_parameters() [fresh]-> ", result);
        if (result != null) {
            invalid_parameters_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_parameters() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            T param_no_default;
            if (
                (_loop0_130 = this._loop0_130()) != null
                &&
    ...
    private final Map<Integer, Memo<T>> invalid_lambda_parameters_cache = new HashMap<>();
    
    protected T invalid_lambda_parameters() {
        int p = this.mark();
        Memo<T> info = invalid_lambda_parameters_cache.get(p);
        if (info != null) {
            log("invalid_lambda_parameters() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_lambda_parameters() ...");
        this._level += 1;
        T result = _invalid_lambda_parameters();
        this._level -= 1;
        log("invalid_lambda_parameters() [fresh]-> ", result);
        if (result != null) {
            invalid_lambda_parameters_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_lambda_parameters() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                (_loop0_132 = this._loop0_132()) != null
                &&
    ...
    private final Map<Integer, Memo<T>> invalid_star_etc_cache = new HashMap<>();
    
    protected T invalid_star_etc() {
        int p = this.mark();
        Memo<T> info = invalid_star_etc_cache.get(p);
        if (info != null) {
            log("invalid_star_etc() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_star_etc() ...");
        this._level += 1;
        T result = _invalid_star_etc();
        this._level -= 1;
        log("invalid_star_etc() [fresh]-> ", result);
        if (result != null) {
            invalid_star_etc_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_star_etc() {
    ...
    private final Map<Integer, Memo<T>> invalid_lambda_star_etc_cache = new HashMap<>();
    
    protected T invalid_lambda_star_etc() {
        int p = this.mark();
        Memo<T> info = invalid_lambda_star_etc_cache.get(p);
        if (info != null) {
            log("invalid_lambda_star_etc() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_lambda_star_etc() ...");
        this._level += 1;
        T result = _invalid_lambda_star_etc();
        this._level -= 1;
        log("invalid_lambda_star_etc() [fresh]-> ", result);
        if (result != null) {
            invalid_lambda_star_etc_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_lambda_star_etc() {
    ...
    private final Map<Integer, Memo<T>> invalid_double_type_comments_cache = new HashMap<>();
    
    protected T invalid_double_type_comments() {
        int p = this.mark();
        Memo<T> info = invalid_double_type_comments_cache.get(p);
        if (info != null) {
            log("invalid_double_type_comments() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_double_type_comments() ...");
        this._level += 1;
        T result = _invalid_double_type_comments();
        this._level -= 1;
        log("invalid_double_type_comments() [fresh]-> ", result);
        if (result != null) {
            invalid_double_type_comments_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_double_type_comments() {
    ...
    private final Map<Integer, Memo<T>> invalid_with_item_cache = new HashMap<>();
    
    protected T invalid_with_item() {
        int p = this.mark();
        Memo<T> info = invalid_with_item_cache.get(p);
        if (info != null) {
            log("invalid_with_item() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_with_item() ...");
        this._level += 1;
        T result = _invalid_with_item();
        this._level -= 1;
        log("invalid_with_item() [fresh]-> ", result);
        if (result != null) {
            invalid_with_item_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_with_item() {
    ...
    private final Map<Integer, Memo<T>> invalid_for_target_cache = new HashMap<>();
    
    protected T invalid_for_target() {
        int p = this.mark();
        Memo<T> info = invalid_for_target_cache.get(p);
        if (info != null) {
            log("invalid_for_target() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_for_target() ...");
        this._level += 1;
        T result = _invalid_for_target();
        this._level -= 1;
        log("invalid_for_target() [fresh]-> ", result);
        if (result != null) {
            invalid_for_target_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_for_target() {
        ...
        int col_offset = this.col_offset();
        {
            T a;
            if (
                (this.expect(TokenType.ASYNC) != null || true)
                &&
                this.expectKeyword("for") != null
                &&
                (a = this.star_expressions()) != null
            ) {
                return RAISE_SYNTAX_ERROR_INVALID_TARGET ( TargetsType.FOR_TARGETS , a );
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> invalid_group_cache = new HashMap<>();
    
    protected T invalid_group() {
        int p = this.mark();
        Memo<T> info = invalid_group_cache.get(p);
        if (info != null) {
            log("invalid_group() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_group() ...");
        this._level += 1;
        T result = _invalid_group();
        this._level -= 1;
        log("invalid_group() [fresh]-> ", result);
        if (result != null) {
            invalid_group_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_group() {
    ...
    private final Map<Integer, Memo<T>> invalid_import_from_targets_cache = new HashMap<>();
    
    protected T invalid_import_from_targets() {
        int p = this.mark();
        Memo<T> info = invalid_import_from_targets_cache.get(p);
        if (info != null) {
            log("invalid_import_from_targets() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("invalid_import_from_targets() ...");
        this._level += 1;
        T result = _invalid_import_from_targets();
        this._level -= 1;
        log("invalid_import_from_targets() [fresh]-> ", result);
        if (result != null) {
            invalid_import_from_targets_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T _invalid_import_from_targets() {
    ...
    private T[] __loop1_22() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_136;
            while (
                (_tmp_136 = this._tmp_136()) != null
            ) {
                children.add(_tmp_136);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private T[] __loop1_32() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_138;
            while (
                (_tmp_138 = this._tmp_138()) != null
            ) {
                children.add(_tmp_138);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private T[] __loop1_68() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_139;
            while (
                (_tmp_139 = this._tmp_139()) != null
            ) {
                children.add(_tmp_139);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop1_70_cache = new HashMap<>();
    
    protected T[] _loop1_70() {
        int p = this.mark();
        Memo<T[]> info = _loop1_70_cache.get(p);
        if (info != null) {
            log("_loop1_70() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_70() ...");
        ...
        T[] result = __loop1_70();
        this._level -= 1;
        log("_loop1_70() [fresh]-> ", result);
        if (result != null) {
            _loop1_70_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_70() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_140;
            while (
                (_tmp_140 = this._tmp_140()) != null
            ) {
                children.add(_tmp_140);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_72_cache = new HashMap<>();
    
    protected T[] _loop0_72() {
        int p = this.mark();
        Memo<T[]> info = _loop0_72_cache.get(p);
        if (info != null) {
            log("_loop0_72() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_72() ...");
        ...
        T[] result = __loop0_72();
        this._level -= 1;
        log("_loop0_72() [fresh]-> ", result);
        if (result != null) {
            _loop0_72_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_72() {
    ...
    private final Map<Integer, Memo<T[]>> _gather_71_cache = new HashMap<>();
    
    protected T[] _gather_71() {
        int p = this.mark();
        Memo<T[]> info = _gather_71_cache.get(p);
        if (info != null) {
            log("_gather_71() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_gather_71() ...");
        this._level += 1;
        T[] result = __gather_71();
        this._level -= 1;
        log("_gather_71() [fresh]-> ", result);
        if (result != null) {
            _gather_71_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __gather_71() {
    ...
    private final Map<Integer, Memo<T[]>> _loop1_73_cache = new HashMap<>();
    
    protected T[] _loop1_73() {
        int p = this.mark();
        Memo<T[]> info = _loop1_73_cache.get(p);
        if (info != null) {
            log("_loop1_73() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_73() ...");
        ...
        T[] result = __loop1_73();
        this._level -= 1;
        log("_loop1_73() [fresh]-> ", result);
        if (result != null) {
            _loop1_73_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_73() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_141;
            while (
                (_tmp_141 = this._tmp_141()) != null
            ) {
                children.add(_tmp_141);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_75_cache = new HashMap<>();
    
    protected T[] _loop0_75() {
        int p = this.mark();
        Memo<T[]> info = _loop0_75_cache.get(p);
        if (info != null) {
            log("_loop0_75() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_75() ...");
        ...
        T[] result = __loop0_75();
        this._level -= 1;
        log("_loop0_75() [fresh]-> ", result);
        if (result != null) {
            _loop0_75_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_75() {
    ...
    private final Map<Integer, Memo<T[]>> _loop1_77_cache = new HashMap<>();
    
    protected T[] _loop1_77() {
        int p = this.mark();
        Memo<T[]> info = _loop1_77_cache.get(p);
        if (info != null) {
            log("_loop1_77() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_77() ...");
        ...
        T[] result = __loop1_77();
        this._level -= 1;
        log("_loop1_77() [fresh]-> ", result);
        if (result != null) {
            _loop1_77_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_77() {
    ...
    private final Map<Integer, Memo<T[]>> _loop1_80_cache = new HashMap<>();
    
    protected T[] _loop1_80() {
        int p = this.mark();
        Memo<T[]> info = _loop1_80_cache.get(p);
        if (info != null) {
            log("_loop1_80() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_80() ...");
        ...
        T[] result = __loop1_80();
        this._level -= 1;
        log("_loop1_80() [fresh]-> ", result);
        if (result != null) {
            _loop1_80_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_80() {
    ...
    private final Map<Integer, Memo<T[]>> _loop0_82_cache = new HashMap<>();
    
    protected T[] _loop0_82() {
        int p = this.mark();
        Memo<T[]> info = _loop0_82_cache.get(p);
        if (info != null) {
            log("_loop0_82() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_82() ...");
        ...
        T[] result = __loop0_82();
        this._level -= 1;
        log("_loop0_82() [fresh]-> ", result);
        if (result != null) {
            _loop0_82_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_82() {
    ...
    private final Map<Integer, Memo<T[]>> _loop1_88_cache = new HashMap<>();
    
    protected T[] _loop1_88() {
        int p = this.mark();
        Memo<T[]> info = _loop1_88_cache.get(p);
        if (info != null) {
            log("_loop1_88() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_88() ...");
        ...
        T[] result = __loop1_88();
        this._level -= 1;
        log("_loop1_88() [fresh]-> ", result);
        if (result != null) {
            _loop1_88_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_88() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_142;
            while (
                (_tmp_142 = this._tmp_142()) != null
            ) {
                children.add(_tmp_142);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private T[] __loop1_89() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_143;
            while (
                (_tmp_143 = this._tmp_143()) != null
            ) {
                children.add(_tmp_143);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_92_cache = new HashMap<>();
    
    protected T[] _loop0_92() {
        int p = this.mark();
        Memo<T[]> info = _loop0_92_cache.get(p);
        if (info != null) {
            log("_loop0_92() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_92() ...");
        ...
        T[] result = __loop0_92();
        this._level -= 1;
        log("_loop0_92() [fresh]-> ", result);
        if (result != null) {
            _loop0_92_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_92() {
        // _loop0_92: ',' slice
        boolean cut = false;
        int mark = this.mark();
        int line_no = this.lineno();
    ...
    private final Map<Integer, Memo<T[]>> _gather_91_cache = new HashMap<>();
    
    protected T[] _gather_91() {
        int p = this.mark();
        Memo<T[]> info = _gather_91_cache.get(p);
        if (info != null) {
            log("_gather_91() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_gather_91() ...");
        this._level += 1;
        T[] result = __gather_91();
        this._level -= 1;
        log("_gather_91() [fresh]-> ", result);
        if (result != null) {
            _gather_91_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __gather_91() {
    ...
    private final Map<Integer, Memo<T>> _tmp_93_cache = new HashMap<>();
    
    protected T _tmp_93() {
        int p = this.mark();
        Memo<T> info = _tmp_93_cache.get(p);
        if (info != null) {
            log("_tmp_93() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_93() ...");
        ...
        T result = __tmp_93();
        this._level -= 1;
        log("_tmp_93() [fresh]-> ", result);
        if (result != null) {
            _tmp_93_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_94_cache = new HashMap<>();
    
    protected T _tmp_94() {
        int p = this.mark();
        Memo<T> info = _tmp_94_cache.get(p);
        if (info != null) {
            log("_tmp_94() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_94() ...");
        ...
        T result = __tmp_94();
        this._level -= 1;
        log("_tmp_94() [fresh]-> ", result);
        if (result != null) {
            _tmp_94_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T[]>> _loop1_97_cache = new HashMap<>();
    
    protected T[] _loop1_97() {
        int p = this.mark();
        Memo<T[]> info = _loop1_97_cache.get(p);
        if (info != null) {
            log("_loop1_97() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_97() ...");
        ...
        T[] result = __loop1_97();
        this._level -= 1;
        log("_loop1_97() [fresh]-> ", result);
        if (result != null) {
            _loop1_97_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_97() {
        // _loop1_97: STRING
        boolean cut = false;
        int mark = this.mark();
        int line_no = this.lineno();
    ...
    private final Map<Integer, Memo<T>> _tmp_99_cache = new HashMap<>();
    
    protected T _tmp_99() {
        int p = this.mark();
        Memo<T> info = _tmp_99_cache.get(p);
        if (info != null) {
            log("_tmp_99() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_99() ...");
        ...
        T result = __tmp_99();
        this._level -= 1;
        log("_tmp_99() [fresh]-> ", result);
        if (result != null) {
            _tmp_99_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_101_cache = new HashMap<>();
    
    protected T[] _loop0_101() {
        int p = this.mark();
        Memo<T[]> info = _loop0_101_cache.get(p);
        if (info != null) {
            log("_loop0_101() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_101() ...");
        this._level += 1;
        T[] result = __loop0_101();
        this._level -= 1;
        log("_loop0_101() [fresh]-> ", result);
        if (result != null) {
            _loop0_101_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_101() {
    ...
    private final Map<Integer, Memo<T[]>> _gather_100_cache = new HashMap<>();
    
    protected T[] _gather_100() {
        int p = this.mark();
        Memo<T[]> info = _gather_100_cache.get(p);
        if (info != null) {
            log("_gather_100() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_gather_100() ...");
        this._level += 1;
        T[] result = __gather_100();
        this._level -= 1;
        log("_gather_100() [fresh]-> ", result);
        if (result != null) {
            _gather_100_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __gather_100() {
    ...
    private final Map<Integer, Memo<T[]>> _loop1_102_cache = new HashMap<>();
    
    protected T[] _loop1_102() {
        int p = this.mark();
        Memo<T[]> info = _loop1_102_cache.get(p);
        if (info != null) {
            log("_loop1_102() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_102() ...");
        this._level += 1;
        T[] result = __loop1_102();
        this._level -= 1;
        log("_loop1_102() [fresh]-> ", result);
        if (result != null) {
            _loop1_102_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_102() {
    ...
    private T[] __loop0_103() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_144;
            while (
                (_tmp_144 = this._tmp_144()) != null
            ) {
                children.add(_tmp_144);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_104_cache = new HashMap<>();
    
    protected T[] _loop0_104() {
        int p = this.mark();
        Memo<T[]> info = _loop0_104_cache.get(p);
        if (info != null) {
            log("_loop0_104() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_104() ...");
        this._level += 1;
        T[] result = __loop0_104();
        this._level -= 1;
        log("_loop0_104() [fresh]-> ", result);
        if (result != null) {
            _loop0_104_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_104() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_145;
            while (
                (_tmp_145 = this._tmp_145()) != null
            ) {
                children.add(_tmp_145);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _gather_105_cache = new HashMap<>();
    
    protected T[] _gather_105() {
        int p = this.mark();
        Memo<T[]> info = _gather_105_cache.get(p);
        if (info != null) {
            log("_gather_105() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_gather_105() ...");
        this._level += 1;
        T[] result = __gather_105();
        this._level -= 1;
        log("_gather_105() [fresh]-> ", result);
        if (result != null) {
            _gather_105_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __gather_105() {
    ...
    private final Map<Integer, Memo<T[]>> _tmp_107_cache = new HashMap<>();
    
    protected T[] _tmp_107() {
        int p = this.mark();
        Memo<T[]> info = _tmp_107_cache.get(p);
        if (info != null) {
            log("_tmp_107() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_107() ...");
        ...
        T[] result = __tmp_107();
        this._level -= 1;
        log("_tmp_107() [fresh]-> ", result);
        if (result != null) {
            _tmp_107_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_109_cache = new HashMap<>();
    
    protected T[] _loop0_109() {
        int p = this.mark();
        Memo<T[]> info = _loop0_109_cache.get(p);
        if (info != null) {
            log("_loop0_109() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_109() ...");
        this._level += 1;
        T[] result = __loop0_109();
        this._level -= 1;
        log("_loop0_109() [fresh]-> ", result);
        if (result != null) {
            _loop0_109_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_109() {
    ...
    private final Map<Integer, Memo<T[]>> _gather_108_cache = new HashMap<>();
    
    protected T[] _gather_108() {
        int p = this.mark();
        Memo<T[]> info = _gather_108_cache.get(p);
        if (info != null) {
            log("_gather_108() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_gather_108() ...");
        this._level += 1;
        T[] result = __gather_108();
        this._level -= 1;
        log("_gather_108() [fresh]-> ", result);
        if (result != null) {
            _gather_108_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __gather_108() {
    ...
    private final Map<Integer, Memo<T[]>> _loop0_116_cache = new HashMap<>();
    
    protected T[] _loop0_116() {
        int p = this.mark();
        Memo<T[]> info = _loop0_116_cache.get(p);
        if (info != null) {
            log("_loop0_116() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_116() ...");
        this._level += 1;
        T[] result = __loop0_116();
        this._level -= 1;
        log("_loop0_116() [fresh]-> ", result);
        if (result != null) {
            _loop0_116_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_116() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_147;
            while (
                (_tmp_147 = this._tmp_147()) != null
            ) {
                children.add(_tmp_147);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _gather_117_cache = new HashMap<>();
    
    protected T[] _gather_117() {
        int p = this.mark();
        Memo<T[]> info = _gather_117_cache.get(p);
        if (info != null) {
            log("_gather_117() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_gather_117() ...");
        this._level += 1;
        T[] result = __gather_117();
        this._level -= 1;
        log("_gather_117() [fresh]-> ", result);
        if (result != null) {
            _gather_117_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __gather_117() {
    ...
    private final Map<Integer, Memo<T[]>> _loop1_119_cache = new HashMap<>();
    
    protected T[] _loop1_119() {
        int p = this.mark();
        Memo<T[]> info = _loop1_119_cache.get(p);
        if (info != null) {
            log("_loop1_119() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_119() ...");
        this._level += 1;
        T[] result = __loop1_119();
        this._level -= 1;
        log("_loop1_119() [fresh]-> ", result);
        if (result != null) {
            _loop1_119_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_119() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_148;
            while (
                (_tmp_148 = this._tmp_148()) != null
            ) {
                children.add(_tmp_148);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T>> _tmp_120_cache = new HashMap<>();
    
    protected T _tmp_120() {
        int p = this.mark();
        Memo<T> info = _tmp_120_cache.get(p);
        if (info != null) {
            log("_tmp_120() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_120() ...");
        ...
        T result = __tmp_120();
        this._level -= 1;
        log("_tmp_120() [fresh]-> ", result);
        if (result != null) {
            _tmp_120_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_122_cache = new HashMap<>();
    
    protected T[] _loop0_122() {
        int p = this.mark();
        Memo<T[]> info = _loop0_122_cache.get(p);
        if (info != null) {
            log("_loop0_122() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_122() ...");
        this._level += 1;
        T[] result = __loop0_122();
        this._level -= 1;
        log("_loop0_122() [fresh]-> ", result);
        if (result != null) {
            _loop0_122_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_122() {
    ...
    private final Map<Integer, Memo<T[]>> _gather_121_cache = new HashMap<>();
    
    protected T[] _gather_121() {
        int p = this.mark();
        Memo<T[]> info = _gather_121_cache.get(p);
        if (info != null) {
            log("_gather_121() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_gather_121() ...");
        this._level += 1;
        T[] result = __gather_121();
        this._level -= 1;
        log("_gather_121() [fresh]-> ", result);
        if (result != null) {
            _gather_121_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __gather_121() {
    ...
    private final Map<Integer, Memo<T>> _tmp_123_cache = new HashMap<>();
    
    protected T _tmp_123() {
        int p = this.mark();
        Memo<T> info = _tmp_123_cache.get(p);
        if (info != null) {
            log("_tmp_123() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_123() ...");
        ...
        T result = __tmp_123();
        this._level -= 1;
        log("_tmp_123() [fresh]-> ", result);
        if (result != null) {
            _tmp_123_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private T __tmp_123() {
        ...
        }
        {
            ...
            if (
                ...
                return ast.aux_make_seq(expression, for_if_clauses);
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> _tmp_124_cache = new HashMap<>();
    
    protected T _tmp_124() {
        int p = this.mark();
        Memo<T> info = _tmp_124_cache.get(p);
        if (info != null) {
            log("_tmp_124() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_124() ...");
        ...
        T result = __tmp_124();
        this._level -= 1;
        log("_tmp_124() [fresh]-> ", result);
        if (result != null) {
            _tmp_124_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private T __tmp_124() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            if (
                ...
                return ast.aux_make_seq(name, literal);
            }
            this.reset(mark);
        }
        return null;
    ...
    private T[] __loop0_125() {
        ...
        List<T> children = new ArrayList<>();
        {
            T[] star_named_expressions;
            while (
                (star_named_expressions = this.star_named_expressions()) != null
            ) {
                children.addAll(Arrays.asList(star_named_expressions));
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_126_cache = new HashMap<>();
    
    protected T[] _loop0_126() {
        int p = this.mark();
        Memo<T[]> info = _loop0_126_cache.get(p);
        if (info != null) {
            log("_loop0_126() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_126() ...");
        this._level += 1;
        T[] result = __loop0_126();
        this._level -= 1;
        log("_loop0_126() [fresh]-> ", result);
        if (result != null) {
            _loop0_126_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_126() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_149;
            while (
                (_tmp_149 = this._tmp_149()) != null
            ) {
                children.add(_tmp_149);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_127_cache = new HashMap<>();
    
    protected T[] _loop0_127() {
        int p = this.mark();
        Memo<T[]> info = _loop0_127_cache.get(p);
        if (info != null) {
            log("_loop0_127() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_127() ...");
        this._level += 1;
        T[] result = __loop0_127();
        this._level -= 1;
        log("_loop0_127() [fresh]-> ", result);
        if (result != null) {
            _loop0_127_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_127() {
        ...
        List<T> children = new ArrayList<>();
        {
            T _tmp_150;
            while (
                (_tmp_150 = this._tmp_150()) != null
            ) {
                children.add(_tmp_150);
                mark = this.mark();
            }
            this.reset(mark);
        }
    ...
    private final Map<Integer, Memo<T[]>> _loop0_130_cache = new HashMap<>();
    
    protected T[] _loop0_130() {
        int p = this.mark();
        Memo<T[]> info = _loop0_130_cache.get(p);
        if (info != null) {
            log("_loop0_130() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_130() ...");
        this._level += 1;
        T[] result = __loop0_130();
        this._level -= 1;
        log("_loop0_130() [fresh]-> ", result);
        if (result != null) {
            _loop0_130_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_130() {
    ...
    private T __tmp_131() {
        ...
        int col_offset = this.col_offset();
        {
            T slash_with_default;
            if (
                (slash_with_default = this.slash_with_default()) != null
            ) {
        ...
        }
        {
            T[] _loop1_151;
            if (
                (_loop1_151 = null_if_empty(this._loop1_151())) != null
            ) {
                return _loop1_151;
            }
            this.reset(mark);
    ...
    private final Map<Integer, Memo<T[]>> _loop0_132_cache = new HashMap<>();
    
    protected T[] _loop0_132() {
        int p = this.mark();
        Memo<T[]> info = _loop0_132_cache.get(p);
        if (info != null) {
            log("_loop0_132() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop0_132() ...");
        this._level += 1;
        T[] result = __loop0_132();
        this._level -= 1;
        log("_loop0_132() [fresh]-> ", result);
        if (result != null) {
            _loop0_132_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop0_132() {
    ...
    private T __tmp_133() {
        ...
        int col_offset = this.col_offset();
        {
            T lambda_slash_with_default;
            if (
                (lambda_slash_with_default = this.lambda_slash_with_default()) != null
            ) {
        ...
        }
        {
            T[] _loop1_152;
            if (
                (_loop1_152 = null_if_empty(this._loop1_152())) != null
            ) {
                return _loop1_152;
            }
            this.reset(mark);
    ...
    private T __tmp_134() {
        ...
        }
        {
            ...
            if (
                (literal = this.expectStr(',')) != null
                &&
                (_tmp_153 = this._tmp_153()) != null
            ) {
                return ast.aux_make_seq(literal, _tmp_153);
            }
            this.reset(mark);
        }
        return null;
    ...
    private T __tmp_135() {
        ...
        }
        {
            ...
            if (
                (literal = this.expectStr(',')) != null
                &&
                (_tmp_154 = this._tmp_154()) != null
            ) {
                return ast.aux_make_seq(literal, _tmp_154);
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> _tmp_138_cache = new HashMap<>();
    
    protected T _tmp_138() {
        int p = this.mark();
        Memo<T> info = _tmp_138_cache.get(p);
        if (info != null) {
            log("_tmp_138() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_138() ...");
        ...
        T result = __tmp_138();
        this._level -= 1;
        log("_tmp_138() [fresh]-> ", result);
        if (result != null) {
            _tmp_138_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_139_cache = new HashMap<>();
    
    protected T _tmp_139() {
        int p = this.mark();
        Memo<T> info = _tmp_139_cache.get(p);
        if (info != null) {
            log("_tmp_139() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_139() ...");
        ...
        T result = __tmp_139();
        this._level -= 1;
        log("_tmp_139() [fresh]-> ", result);
        if (result != null) {
            _tmp_139_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_140_cache = new HashMap<>();
    
    protected T _tmp_140() {
        int p = this.mark();
        Memo<T> info = _tmp_140_cache.get(p);
        if (info != null) {
            log("_tmp_140() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_140() ...");
        ...
        T result = __tmp_140();
        this._level -= 1;
        log("_tmp_140() [fresh]-> ", result);
        if (result != null) {
            _tmp_140_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_141_cache = new HashMap<>();
    
    protected T _tmp_141() {
        int p = this.mark();
        Memo<T> info = _tmp_141_cache.get(p);
        if (info != null) {
            log("_tmp_141() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_141() ...");
        ...
        T result = __tmp_141();
        this._level -= 1;
        log("_tmp_141() [fresh]-> ", result);
        if (result != null) {
            _tmp_141_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_142_cache = new HashMap<>();
    
    protected T _tmp_142() {
        int p = this.mark();
        Memo<T> info = _tmp_142_cache.get(p);
        if (info != null) {
            log("_tmp_142() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_142() ...");
        ...
        T result = __tmp_142();
        this._level -= 1;
        log("_tmp_142() [fresh]-> ", result);
        if (result != null) {
            _tmp_142_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_143_cache = new HashMap<>();
    
    protected T _tmp_143() {
        int p = this.mark();
        Memo<T> info = _tmp_143_cache.get(p);
        if (info != null) {
            log("_tmp_143() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_143() ...");
        ...
        T result = __tmp_143();
        this._level -= 1;
        log("_tmp_143() [fresh]-> ", result);
        if (result != null) {
            _tmp_143_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_144_cache = new HashMap<>();
    
    protected T _tmp_144() {
        int p = this.mark();
        Memo<T> info = _tmp_144_cache.get(p);
        if (info != null) {
            log("_tmp_144() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_144() ...");
        ...
        T result = __tmp_144();
        this._level -= 1;
        log("_tmp_144() [fresh]-> ", result);
        if (result != null) {
            _tmp_144_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_145_cache = new HashMap<>();
    
    protected T _tmp_145() {
        int p = this.mark();
        Memo<T> info = _tmp_145_cache.get(p);
        if (info != null) {
            log("_tmp_145() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_145() ...");
        ...
        T result = __tmp_145();
        this._level -= 1;
        log("_tmp_145() [fresh]-> ", result);
        if (result != null) {
            _tmp_145_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_146_cache = new HashMap<>();
    
    protected T _tmp_146() {
        int p = this.mark();
        Memo<T> info = _tmp_146_cache.get(p);
        if (info != null) {
            log("_tmp_146() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_146() ...");
        ...
        T result = __tmp_146();
        this._level -= 1;
        log("_tmp_146() [fresh]-> ", result);
        if (result != null) {
            _tmp_146_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_147_cache = new HashMap<>();
    
    protected T _tmp_147() {
        int p = this.mark();
        Memo<T> info = _tmp_147_cache.get(p);
        if (info != null) {
            log("_tmp_147() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_147() ...");
        ...
        T result = __tmp_147();
        this._level -= 1;
        log("_tmp_147() [fresh]-> ", result);
        if (result != null) {
            _tmp_147_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_148_cache = new HashMap<>();
    
    protected T _tmp_148() {
        int p = this.mark();
        Memo<T> info = _tmp_148_cache.get(p);
        if (info != null) {
            log("_tmp_148() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_148() ...");
        ...
        T result = __tmp_148();
        this._level -= 1;
        log("_tmp_148() [fresh]-> ", result);
        if (result != null) {
            _tmp_148_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_149_cache = new HashMap<>();
    
    protected T _tmp_149() {
        int p = this.mark();
        Memo<T> info = _tmp_149_cache.get(p);
        if (info != null) {
            log("_tmp_149() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_149() ...");
        ...
        T result = __tmp_149();
        this._level -= 1;
        log("_tmp_149() [fresh]-> ", result);
        if (result != null) {
            _tmp_149_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private T __tmp_149() {
        ...
        int col_offset = this.col_offset();
        {
            ...
            Token literal;
            if (
                (star_targets = this.star_targets()) != null
                &&
                (literal = this.expectStr('=')) != null
            ) {
                return ast.aux_make_seq(star_targets, literal);
            }
            this.reset(mark);
        }
        return null;
    ...
    private final Map<Integer, Memo<T>> _tmp_150_cache = new HashMap<>();
    
    protected T _tmp_150() {
        int p = this.mark();
        Memo<T> info = _tmp_150_cache.get(p);
        if (info != null) {
            log("_tmp_150() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_150() ...");
        ...
        T result = __tmp_150();
        this._level -= 1;
        log("_tmp_150() [fresh]-> ", result);
        if (result != null) {
            _tmp_150_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T[]>> _loop1_151_cache = new HashMap<>();
    
    protected T[] _loop1_151() {
        int p = this.mark();
        Memo<T[]> info = _loop1_151_cache.get(p);
        if (info != null) {
            log("_loop1_151() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_151() ...");
        this._level += 1;
        T[] result = __loop1_151();
        this._level -= 1;
        log("_loop1_151() [fresh]-> ", result);
        if (result != null) {
            _loop1_151_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_151() {
    ...
    private final Map<Integer, Memo<T[]>> _loop1_152_cache = new HashMap<>();
    
    protected T[] _loop1_152() {
        int p = this.mark();
        Memo<T[]> info = _loop1_152_cache.get(p);
        if (info != null) {
            log("_loop1_152() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_loop1_152() ...");
        this._level += 1;
        T[] result = __loop1_152();
        this._level -= 1;
        log("_loop1_152() [fresh]-> ", result);
        if (result != null) {
            _loop1_152_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    
    private T[] __loop1_152() {
    ...
    private final Map<Integer, Memo<T>> _tmp_153_cache = new HashMap<>();
    
    protected T _tmp_153() {
        int p = this.mark();
        Memo<T> info = _tmp_153_cache.get(p);
        if (info != null) {
            log("_tmp_153() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_153() ...");
        ...
        T result = __tmp_153();
        this._level -= 1;
        log("_tmp_153() [fresh]-> ", result);
        if (result != null) {
            _tmp_153_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }
    ...
    private final Map<Integer, Memo<T>> _tmp_154_cache = new HashMap<>();
    
    protected T _tmp_154() {
        int p = this.mark();
        Memo<T> info = _tmp_154_cache.get(p);
        if (info != null) {
            log("_tmp_154() [cached]-> " + info.toString());
            this.reset(info.end_mark);
            return info.item;
        }
        logl("_tmp_154() ...");
        ...
        T result = __tmp_154();
        this._level -= 1;
        log("_tmp_154() [fresh]-> ", result);
        if (result != null) {
            _tmp_154_cache.put(p, new Memo<>(result, this.mark()));
        }
        return result;
    }

...
public static final PyType TYPE = PyType.fromClass(ImportFrom.class);
    ...
    new PyString[] {new PyString("module"), new PyString("names"), new
                     PyString("level")};
    ...
    public ImportFrom(Token token, String module, java.util.List<alias> names,
                      Integer level) {
        super(token);
        this.module = module;
        this.names = names;
    ...
    public ImportFrom(PythonTree tree, String module, java.util.List<alias>
                      names, Integer level) {
        super(tree);
        this.module = module;
        this.names = names;

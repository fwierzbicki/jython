...
public static final PyType TYPE = PyType.fromClass(Subscript.class);
    ...
    new PyString[] {new PyString("value"), new PyString("slice"), new
                     PyString("ctx")};
    ...
    public Subscript(Token token, expr value, slice slice, expr_contextType
                     ctx) {
        super(token);
        this.value = value;
        addChild(value);
    ...
    public Subscript(PythonTree tree, expr value, slice slice, expr_contextType
                     ctx) {
        super(tree);
        this.value = value;
        addChild(value);

...
public static final PyType TYPE = PyType.fromClass(Call.class);
    ...
    new PyString[] {new PyString("func"), new PyString("args"), new
                     PyString("keywords"), new PyString("starargs"), new
                     PyString("kwargs")};
    ...
    public Call(Integer ttype, Token token, expr func, java.util.List<expr>
                args, java.util.List<keyword> keywords, expr starargs, expr
                kwargs) {
        super(ttype, token);
        this.func = func;
        addChild(func);

...
public class arguments extends PythonTree {
    ...
    new PyString[] {new PyString("args"), new PyString("vararg"), new
                     PyString("kwarg"), new PyString("defaults")};
    ...
    public arguments(PyObject args, PyObject vararg, PyObject kwarg, PyObject
                     defaults) {
        setArgs(args);
        setVararg(vararg);
        setKwarg(kwarg);
    ...
    public arguments(Integer ttype, Token token, java.util.List<expr> args,
                     String vararg, String kwarg, java.util.List<expr>
                     defaults) {
        super(ttype, token);
        this.args = args;
        if (args == null) {

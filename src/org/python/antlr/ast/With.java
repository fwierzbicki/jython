...
public static final PyType TYPE = PyType.fromClass(With.class);
    ...
    new PyString[] {new PyString("context_expr"), new
                     PyString("optional_vars"), new PyString("body")};
    ...
    public void With___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("With", args, keywords, new String[]
            {"context_expr", "optional_vars", "body", "lineno", "col_offset"},
              3, true);
    ...
    public With(Integer ttype, Token token, expr context_expr, expr
                optional_vars, java.util.List<stmt> body) {
        super(ttype, token);
        this.context_expr = context_expr;
        addChild(context_expr);
        this.optional_vars = optional_vars;

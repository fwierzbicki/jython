...
public static final PyType TYPE = PyType.fromClass(Attribute.class);
    ...
    new PyString[] {new PyString("value"), new PyString("attr"), new
                     PyString("ctx")};
    ...
    public Attribute(Token token, expr value, String attr, expr_contextType
                     ctx) {
        super(token);
        this.value = value;
        addChild(value);
    ...
    public Attribute(PythonTree tree, expr value, String attr, expr_contextType
                     ctx) {
        super(tree);
        this.value = value;
        addChild(value);

...
public static final PyType TYPE = PyType.fromClass(For.class);
    ...
    new PyString[] {new PyString("target"), new PyString("iter"), new
                     PyString("body"), new PyString("orelse")};
    ...
    public For(PythonTree tree, expr target, expr iter, java.util.List<stmt>
               body, java.util.List<stmt> orelse) {
        super(tree);
        this.target = target;
        addChild(target);
        this.iter = iter;
